...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\Column(name: 'user_pwd')]
    private ?string $password = null;

    #[ORM\Column(name: 'user_lastname', length: 160)]
    private ?string $lastname = null;

    #[ORM\Column(name: 'user_firstname', length: 160)]
    private ?string $firstname = null;

    #[ORM\Column(name: 'user_is_ban')]
    private bool $isBan = false;

    #[ORM\Column(name: 'user_created_at')]
    private ?\DateTimeImmutable $createdAt = null;

    #[ORM\Column(name: 'user_updated_at', nullable: true)]
    private ?\DateTimeImmutable $updatedAt = null;

    #[ORM\Column(name: 'user_deleted_at', nullable: true)]
     ...
     */
    #[ORM\JoinTable('users_allergens')]
    #[ORM\JoinColumn(name: 'usr_alg_user', referencedColumnName: 'user_id')]
    #[ORM\InverseJoinColumn(name: 'usr_alg_allergen', referencedColumnName: 'allergen_id')]
